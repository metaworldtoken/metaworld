...
cd $libdir
download "https://github.com/metaworld/irrlicht/releases/download/$irrlicht_version/win32.zip" irrlicht-$irrlicht_version.zip
download "http://metaworld.kitsunemimi.pw/zlib-$zlib_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/zstd-$zstd_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/libogg-$ogg_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/libvorbis-$vorbis_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/curl-$curl_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/gettext-$gettext_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/freetype2-$freetype_version-win32.zip" freetype-$freetype_version.zip
download "http://metaworld.kitsunemimi.pw/sqlite3-$sqlite3_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/luajit-$luajit_version-win32.zip"
download "http://metaworld.kitsunemimi.pw/libleveldb-$leveldb_version-win32.zip" leveldb-$leveldb_version.zip
download "http://metaworld.kitsunemimi.pw/openal_stripped.zip" '' unzip_nofolder
