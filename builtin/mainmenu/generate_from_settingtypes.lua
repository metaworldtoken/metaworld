...
local metaworld_example_header = [[
#    This file contains a list of all available settings and their default value for metaworld.conf

#    By default, all the settings are commented and not functional.
#    Uncomment settings by removing the preceding #.

#    metaworld.conf is read by default from:
#    ../metaworld.conf
#    ../../metaworld.conf
#    Any other path can be chosen by passing the path as a parameter
#    to the program, eg. "metaworld.exe --config ../metaworld.conf.example".

#    Further documentation:
#    http://wiki.metaworld.net/
...
local function create_metaworld_conf_example()
	local result = { metaworld_example_header }
...
local file = assert(io.open("metaworld.conf.example", "w"))
file:write(create_metaworld_conf_example())
file:close()

file = assert(io.open("src/settings_translation_file.cpp", "w"))
-- If 'metaworld.conf.example' appears in the 'bin' folder, the line below may have to be
