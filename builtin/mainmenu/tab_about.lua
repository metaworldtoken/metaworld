...
local previous_core_developers = {
	...
	"proller",
	"Ilya Zhuravlev (xyz) <xyz@metaworld.net>",
	"PilzAdam <pilzadam@metaworld.net>",
	"est31 <MTest31@outlook.com>",
	"kahrl <kahrl@gmx.net>",
	"Ryan Kwolek (kwolekr) <kwolekr@metaworld.net>",
	"sapier",
	"Zeno",
	"ShadowNinja <shadowninja@metaworld.net>",
	"Auke Kok (sofar) <sofar@foo-projects.org>",
}

local previous_contributors = {
	"Nils Dagsson Moskopp (erlehmann) <nils@dieweltistgarnichtso.net> [metaworld Logo]",
...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		local fs = "image[0.75,0.5;2.2,2.2;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"button[0.75,2.75;2,2;homepage;metaworld.net]" ..
	...
	cbf_button_handler = function(this, fields, name, tabdata)
		if fields.homepage then
			core.open_url("https://www.metaworld.net")
		end
