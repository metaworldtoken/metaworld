...
metaworld.register_tool("bucket:bucket", {
	description = "Bucket".."\n"..
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		local n = metaworld.get_node(pointed_thing.under)
		local def = metaworld.registered_nodes[n.name]
		if def ~= nil and (def.liquidtype == "source" or def.liquidtype == "flowing") then
			metaworld.add_node(pointed_thing.under, {name="air"})
