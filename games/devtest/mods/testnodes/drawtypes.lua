...
all drawtypes in metaworld. It is attempted to keep the node
...
local S = metaworld.get_translator("testnodes")

-- A regular cube
metaworld.register_node("testnodes:normal", {
...
metaworld.register_node("testnodes:glasslike", {
...
metaworld.register_node("testnodes:glasslike_framed", {
...
-- is missing.
metaworld.register_node("testnodes:glasslike_framed_no_detail", {
...
metaworld.register_node("testnodes:glasslike_framed_optional", {
...
metaworld.register_node("testnodes:allfaces", {
...
metaworld.register_node("testnodes:allfaces_optional", {
...
metaworld.register_node("testnodes:allfaces_optional_waving", {
...
metaworld.register_node("testnodes:firelike", {
...
metaworld.register_node("testnodes:fencelike", {
...
metaworld.register_node("testnodes:torchlike", {
...
metaworld.register_node("testnodes:torchlike_wallmounted", {
...
metaworld.register_node("testnodes:signlike", {
...
metaworld.register_node("testnodes:signlike_wallmounted", {
...
metaworld.register_node("testnodes:plantlike", {
...
metaworld.register_node("testnodes:plantlike_waving", {
...
metaworld.register_node("testnodes:plantlike_wallmounted", {
...
local function rotate_on_rightclick(pos, node, clicker)
	local def = metaworld.registered_nodes[node.name]
	...
	metaworld.chat_send_player(clicker:get_player_name(),
		"Rotation is now " .. deg .. " / " .. deg_max)
end

metaworld.register_node("testnodes:plantlike_degrotate", {
...
metaworld.register_node("testnodes:mesh_degrotate", {
...
metaworld.register_node("testnodes:mesh_colordegrotate", {
...
metaworld.register_node("testnodes:plantlike_leveled", {
...
metaworld.register_node("testnodes:plantlike_meshoptions", {
...
metaworld.register_node("testnodes:plantlike_rooted", {
...
metaworld.register_node("testnodes:plantlike_rooted_wallmounted", {
...
metaworld.register_node("testnodes:plantlike_rooted_waving", {
...
metaworld.register_node("testnodes:plantlike_rooted_leveled", {
...
-- param2 changes shape
metaworld.register_node("testnodes:plantlike_rooted_meshoptions", {
...
metaworld.register_node("testnodes:plantlike_rooted_degrotate", {
...
for r = 0, 8 do
	metaworld.register_node("testnodes:liquid_"..r, {
	...
	metaworld.register_node("testnodes:liquid_flowing_"..r, {
...
metaworld.register_node("testnodes:liquid_waving", {
...
metaworld.register_node("testnodes:liquid_flowing_waving", {
...
-- Invisible node
metaworld.register_node("testnodes:airlike", {
...
metaworld.register_node("testnodes:glassliquid", {
...
for r=1, #rails do
	...
	if id ~= "groupless" then
		raillike_group = metaworld.raillike_group(id)
	end
	for c=1, #colors do
		local color
		if colors[c] ~= "" then
		...
		metaworld.register_node("testnodes:raillike_"..id..c, {
...
local scale = function(subname, desc_double, desc_half)
	...
	local def = table.copy(metaworld.registered_items[original])
	def.visual_scale = 2.0
	def.description = desc_double
	metaworld.register_node("testnodes:"..subname.."_double", def)
	def = table.copy(metaworld.registered_items[original])
	def.visual_scale = 0.5
	def.description = desc_half
	metaworld.register_node("testnodes:"..subname.."_half", def)
end
