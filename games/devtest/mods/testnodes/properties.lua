...
metaworld.register_node("testnodes:falling", {
...
metaworld.register_node("testnodes:falling_float", {
...
metaworld.register_node("testnodes:attached", {
...
metaworld.register_node("testnodes:attached_wallmounted", {
...
-- Jump disabled
metaworld.register_node("testnodes:nojump", {
...
-- Jump disabled plant
metaworld.register_node("testnodes:nojump_walkable", {
...
metaworld.register_node("testnodes:climbable", {
...
metaworld.register_node("testnodes:climbable_nojump", {
...
metaworld.register_node("testnodes:liquid_nojump", {
...
metaworld.register_node("testnodes:liquidflowing_nojump", {
...
metaworld.register_node("testnodes:liquid_noswim", {
...
metaworld.register_node("testnodes:liquidflowing_noswim", {
...
for i=-100, 100, 25 do
	if i ~= 0 then
		...
		metaworld.register_node("testnodes:damage"..subname, {
			description = desc,
...
for i=20, 180, 20 do
	...
	metaworld.register_node("testnodes:bouncy"..i, {
...
for i=1, 5 do
	metaworld.register_node("testnodes:slippery"..i, {
...
for r=0, 7 do
	if r > 0 then
		metaworld.register_node("testnodes:move_resistance"..r, {
	...
	metaworld.register_node("testnodes:move_resistance_liquidlike"..r, {
...
metaworld.register_node("testnodes:climbable_move_resistance_4", {
...
metaworld.register_node("testnodes:buildable_to", {
...
for d=-3,3 do
	if d ~= 0 then
		...
		metaworld.register_node("testnodes:damage_"..sub, {
...
metaworld.register_node("testnodes:drowning_1", {
