...
for i=1, metaworld.LIGHT_MAX do
	metaworld.register_node("testnodes:light"..i, {
...
metaworld.register_node("testnodes:sunlight_filter", {
...
metaworld.register_node("testnodes:sunlight_propagator", {
