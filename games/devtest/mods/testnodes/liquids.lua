...
for d=0, 8 do
	metaworld.register_node("testnodes:rliquid_"..d, {
	...
	metaworld.register_node("testnodes:rliquid_flowing_"..d, {
	...
	metaworld.register_node("testnodes:vliquid_"..d, {
	...
	metaworld.register_node("testnodes:vliquid_flowing_"..d, {
	...
	local v = 4
	metaworld.register_node("testnodes:vrliquid_"..d, {
	...
	metaworld.register_node("testnodes:vrliquid_flowing_"..d, {
