...
metaworld.register_node("testnodes:6sides", {
...
metaworld.register_node("testnodes:anim", {
...
for a=1,#alphas do
	...
	metaworld.register_node("testnodes:alpha_texture_"..alpha, {
	...
	metaworld.register_node("testnodes:alpha_"..alpha, {
...
local textures_path = metaworld.get_modpath( metaworld.get_current_modname() ) .. "/textures/"
metaworld.safe_file_write(
	textures_path .. "testnodes_generated_mb.png",
	metaworld.encode_png(512,512,data_mb)
)
metaworld.safe_file_write(
	textures_path .. "testnodes_generated_ck.png",
	metaworld.encode_png(512,512,data_ck)
)

metaworld.register_node("testnodes:generated_png_mb", {
	description = S("Generated Mandelbrot PNG Test Node"),
	tiles = { "testnodes_generated_mb.png" },

	groups = { dig_immediate = 2 },
})
metaworld.register_node("testnodes:generated_png_ck", {
...
local png_emb = "[png:" .. metaworld.encode_base64(metaworld.encode_png(64,64,data_emb))

metaworld.register_node("testnodes:generated_png_emb", {
	description = S("Generated In-Band Mandelbrot PNG Test Node"),
	tiles = { png_emb },

	groups = { dig_immediate = 2 },
})
metaworld.register_node("testnodes:generated_png_src_emb", {
	description = S("Generated In-Band Source Blit Mandelbrot PNG Test Node"),
	tiles = { png_emb .. "^testnodes_damage_neg.png" },

	groups = { dig_immediate = 2 },
})
metaworld.register_node("testnodes:generated_png_dst_emb", {
