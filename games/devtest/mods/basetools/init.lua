...
-- The hand
if metaworld.settings:get_bool("creative_mode") then
	local digtime = 42
	local caps = {times = {digtime, digtime, digtime}, uses = 0, maxlevel = 256}

	metaworld.register_item(":", {
		type = "none",
...
metaworld.register_tool("basetools:pick_mese", {
...
metaworld.register_tool("basetools:pick_wood", {
...
metaworld.register_tool("basetools:pick_stone", {
...
metaworld.register_tool("basetools:pick_steel", {
...
metaworld.register_tool("basetools:pick_steel_l1", {
...
metaworld.register_tool("basetools:pick_steel_l2", {
...
metaworld.register_tool("basetools:shovel_wood", {
...
metaworld.register_tool("basetools:shovel_stone", {
...
metaworld.register_tool("basetools:shovel_steel", {
...
metaworld.register_tool("basetools:axe_wood", {
...
metaworld.register_tool("basetools:axe_stone", {
...
metaworld.register_tool("basetools:axe_steel", {
...
metaworld.register_tool("basetools:shears_wood", {
...
metaworld.register_tool("basetools:shears_stone", {
...
metaworld.register_tool("basetools:shears_steel", {
...
metaworld.register_tool("basetools:sword_wood", {
...
metaworld.register_tool("basetools:sword_stone", {
...
metaworld.register_tool("basetools:sword_steel", {
...
metaworld.register_tool("basetools:sword_fire", {
...
metaworld.register_tool("basetools:sword_ice", {
...
--
metaworld.register_tool("basetools:dagger_steel", {
...
for i=1, #uses do
	...
	metaworld.register_tool("basetools:pick_uses_"..string.format("%05d", u), {
	...
	metaworld.register_tool("basetools:sword_uses_"..string.format("%05d", u), {
