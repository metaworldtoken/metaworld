...
metaworld.register_node("basenodes:stone", {
	description = "Stone",
	tiles = {"default_stone.png"},
	groups = {cracky=3},
})

metaworld.register_node("basenodes:desert_stone", {
	description = "Desert Stone",
	tiles = {"default_desert_stone.png"},
	groups = {cracky=3},
})

metaworld.register_node("basenodes:dirt_with_grass", {
...
metaworld.register_node("basenodes:dirt_with_snow", {
...
metaworld.register_node("basenodes:dirt", {
	description = "Dirt",
	tiles ={"default_dirt.png"},
	groups = {crumbly=3, soil=1},
})

metaworld.register_node("basenodes:sand", {
	description = "Sand",
	tiles ={"default_sand.png"},
	groups = {crumbly=3},
})

metaworld.register_node("basenodes:desert_sand", {
	description = "Desert Sand",
	tiles ={"default_desert_sand.png"},
	groups = {crumbly=3},
})

metaworld.register_node("basenodes:gravel", {
	description = "Gravel",
	tiles ={"default_gravel.png"},
	groups = {crumbly=2},
})

metaworld.register_node("basenodes:junglegrass", {
...
metaworld.register_node("basenodes:tree", {
...
metaworld.register_node("basenodes:leaves", {
...
metaworld.register_node("basenodes:jungletree", {
...
metaworld.register_node("basenodes:jungleleaves", {
...
metaworld.register_node("basenodes:pine_tree", {
...
metaworld.register_node("basenodes:pine_needles", {
...
metaworld.register_node("basenodes:water_source", {
...
metaworld.register_node("basenodes:water_flowing", {
...
metaworld.register_node("basenodes:river_water_source", {
...
metaworld.register_node("basenodes:river_water_flowing", {
...
metaworld.register_node("basenodes:lava_flowing", {
	...
	paramtype = "light",
	light_source = metaworld.LIGHT_MAX,
	walkable = false,
	pointable = false,
	diggable = false,
	buildable_to = true,
...
metaworld.register_node("basenodes:lava_source", {
...
metaworld.register_node("basenodes:cobble", {
...
metaworld.register_node("basenodes:mossycobble", {
...
metaworld.register_node("basenodes:apple", {
	description = "Apple".."\n"..
		"Food (+2)",
	drawtype = "plantlike",
	...
	on_use = metaworld.item_eat(2),
})

metaworld.register_node("basenodes:ice", {
	description = "Ice",
...
-- distinguishable
metaworld.register_node("basenodes:snow", {
...
metaworld.register_node("basenodes:snowblock", {
