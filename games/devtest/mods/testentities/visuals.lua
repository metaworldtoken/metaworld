...
metaworld.register_entity("testentities:sprite", {
	initial_properties = {
		visual = "sprite",
...
metaworld.register_entity("testentities:upright_sprite", {
	initial_properties = {
...
metaworld.register_entity("testentities:cube", {
	initial_properties = {
		visual = "cube",
		textures = {
...
metaworld.register_entity("testentities:item", {
	initial_properties = {
		visual = "item",
...
metaworld.register_entity("testentities:wielditem", {
	initial_properties = {
		visual = "wielditem",
		wield_item = "testnodes:normal",
	},
...
metaworld.register_entity("testentities:mesh", {
	initial_properties = {
		visual = "mesh",
...
metaworld.register_entity("testentities:mesh_unshaded", {
	initial_properties = {
		visual = "mesh",
		mesh = "testnodes_pyramid.obj",
		textures = {
...
metaworld.register_entity("testentities:yawsprite", {
	initial_properties = {
...
metaworld.register_entity("testentities:upright_animated", {
	initial_properties = {
		visual = "upright_sprite",
...
metaworld.register_entity("testentities:nametag", {
	initial_properties = {
		visual = "sprite",
		textures = { "testentities_sprite.png" },
	},
	...
	on_activate = function(self, staticdata)
		if staticdata ~= "" then
			local data = metaworld.deserialize(staticdata)
	...
	get_staticdata = function(self)
		return metaworld.serialize({ color = self.color, bgcolor = self.bgcolor })
	end,
})
