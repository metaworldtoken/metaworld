...
for k,v in pairs(simple_nodes) do
	metaworld.register_node("soundstuff:"..k, {
		description = v[1],
...
metaworld.register_node("soundstuff:place_failed_attached", {
...
metaworld.register_node("soundstuff:fall", {
...
metaworld.register_node("soundstuff:fall_attached", {
...
metaworld.register_node("soundstuff:footstep_liquid", {
...
metaworld.register_node("soundstuff:footstep_climbable", {
...
metaworld.register_node("soundstuff:positional", {
	...
	on_timer = function(pos, elapsed)
		...
		metaworld.sound_play("soundstuff_mono", { pos = pos, max_hear_distance = dist })
		local timer = metaworld.get_node_timer(pos)
		timer:start(0.7)
	end,
	on_rightclick = function(pos, node, clicker)
		...
		if clicker and clicker:is_player() then
			...
			metaworld.chat_send_player(clicker:get_player_name(), "max_hear_distance = " .. diststr)
		end
	end,
