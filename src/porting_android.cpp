 ...
 */
extern "C" {
	JNIEXPORT void JNICALL Java_net_metaworld_metaworld_GameActivity_putMessageBoxResult(
			JNIEnv *env, jclass thiz, jstring text)
	{
		errorstream <<
			"Java_net_metaworld_metaworld_GameActivity_putMessageBoxResult got: " <<
...
void initAndroid()
{
	...
	nativeActivity = findClass("net/metaworld/metaworld/GameActivity");
