...
fake_function() {
	...
	gettext("Windows systems only: Start metaworld with the command line window in the background.\nContains the same information as the file debug.txt (default name).");
	gettext("Sound");
	gettext("Sound");
	...
	gettext("Prometheus listener address.\nIf metaworld is compiled with ENABLE_PROMETHEUS option enabled,\nenable metrics listener for Prometheus on that address.\nMetrics can be fetched on http://127.0.0.1:30000/metrics");
	...
	gettext("Comma-separated list of flags to hide in the content repository.\n\"nonfree\" can be used to hide packages which do not qualify as 'free software',\nas defined by the Free Software Foundation.\nYou can also specify content ratings.\nThese flags are independent from metaworld versions,\nso see a full list at https://content.metaworld.net/help/content_flags/");
