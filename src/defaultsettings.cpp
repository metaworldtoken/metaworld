...
void set_default_settings()
{
	...
	settings->setDefault("serverlist_url", "servers.metaworld.net");
	...
	// ContentDB
	settings->setDefault("contentdb_url", "https://content.metaworld.net");
	...
	settings->setDefault("default_game", "metaworld");
