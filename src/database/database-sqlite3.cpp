...
// Note: I've seen occasional delays of over 250ms while running metaworldmapper.
...
#define BUSY_FATAL_TRESHOLD	3000	// Allow SQLITE_BUSY to be returned, which will cause a metaworld crash.
